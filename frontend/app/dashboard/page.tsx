      ...
      <nav className="border-b bg-white">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/help" className="flex items-center gap-1 text-sm text-zinc-600 hover:text-zinc-900">
              <HelpCircle className="w-4 h-4" /> Help
            </Link>
            <span className="text-sm text-zinc-500">{user.email}</span>
            <button onClick={logout} className="flex items-center gap-1 text-sm text-zinc-600 hover:text-zinc-900">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-wrap gap-4 mb-8">
          {[
            ...
            <Link key={href} href={href} className="flex items-center gap-2 px-4 py-2 bg-white border rounded-lg hover:border-primary hover:text-primary">
